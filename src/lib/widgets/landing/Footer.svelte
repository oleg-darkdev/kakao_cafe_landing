			...
			<div class="padding-vertical padding-xxlarge">
				<div class="padding-bottom padding-xxlarge">
					<div class="w-layout-grid footer4_top-wrapper">
						<a
							href="/"
							id="w-node-_643f7b28-0097-e68b-64b0-8bb2dc0b9a91-ba1b61fe"
							aria-current="page"
							class="footer4_logo-link w-nav-brand w--current"
						>
							<img
						...
						<div class="w-layout-grid footer4_link-list">
							...
							<a href="{link}" class="footer4_link">{title}</a>
							{/each}
						</div>
						<div
							id="w-node-_643f7b28-0097-e68b-64b0-8bb2dc0b9a9e-ba1b61fe"
				...
				<div class="padding-top padding-medium">
					<div class="w-layout-grid footer4_bottom-wrapper">
						<div
							id="w-node-_643f7b28-0097-e68b-64b0-8bb2dc0b9aac-ba1b61fe"
							class="footer4_credit-text"
						>
							© 2024 GreenLeaf Café. All rights reserved.
						</div>
						<a href="#" class="footer4_legal-link">Privacy Policy</a>
						<a href="#" class="footer4_legal-link">Terms of Service</a>
						<a href="#" class="footer4_legal-link">Cookie Settings</a>
					</div>
				</div>
			</div>
		</div>
